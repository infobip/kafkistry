...
interface RecordSamplingListener {
     ...
     */
    fun need(samplingPosition: SamplingPosition, clusterIdentifier: KafkaClusterIdentifier, topicName: TopicName): Boolean

    /**
     * Return sampler which will be used for one round of sampling from one cluster
     */
    fun sampler(samplingPosition: SamplingPosition, clusterIdentifier: KafkaClusterIdentifier): RecordSampler
