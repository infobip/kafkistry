...
| `app.metrics.topic-status.omit-ok-statuses`                           | `false` | When `true` statuses with name `OK` won't be included in samples with goal to reduce number of exported metric samples.                                            |
