<#-- @ftlvariable name="statusFlags" type="com.infobip.kafkistry.service.StatusFlags" -->
<#-- @ftlvariable name="clusterStatusFlags" type="java.util.Map<java.lang.String, com.infobip.kafkistry.service.StatusFlags>" -->
<#-- @ftlvariable name="allTopicStatusTypes" type="java.util.List<com.infobip.kafkistry.service.InspectionResultType>" -->
<#-- @ftlvariable name="nonOkTopicStatusTypes" type="java.util.List<com.infobip.kafkistry.service.InspectionResultType>" -->
